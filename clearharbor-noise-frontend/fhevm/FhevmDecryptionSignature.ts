...
/**
 * Remove decryption signature from storage for a specific account
 */
export function removeDecryptionSignature(account: string): void {
  if (typeof window === "undefined") return;
  // Remove all decryption signatures for this account
  // This is a simple implementation that removes all keys starting with the account address
